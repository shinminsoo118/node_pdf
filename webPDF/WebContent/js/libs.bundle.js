...
Strophe = {
     ...
     *  NS.SEARCH - JID search operations namespace from XEP-0055.
    ...
    NS: {
        ...
        MUC_ROOM: "http://jabber.org/protocol/muc#rooms",
        POKE: "http://jabber.org/protocol/poke",
    ...
    ID: {
        BUDDY_SEARCH: "buddySearchId01",
        BUDDY_SEARCH_ID: "buddySearchId02",
        BUDDY_ADD: "buddyAddId01",
        BUDDY_MODIFY: "buddyModifyId01",
        BUDDY_GROUPADD: "buddyGroupAddId01",
        BUDDY_GROUPMODIFY: "buddyGroupModifyId01",
        BUDDY_LIST: "buddyLIstId01",
        BUDDY_MANAGER_LIST: "buddyManagerLIstId01",
        BUDDY_GROUP_LIST: "buddyGroupLIstId01",
        BUDDY_DELETE: "buddyDeleteId01",
        BUDDY_REGISTER: "buddyRegisterId01",
        BUDDY_REGISTERVIEW: "buddyRegisterViewId01",
        VCARD_INFO_GET: "vCardInfoGetId01",
        VCARD_INFO_SET: "vCardInfoSetId01",
        PRIVACY_INFO_SET: "privacyInfoSetId01",
        PRIVACY_INFO_GET: "privacyInfoGetId01",
        DISCO_ITEMS_GET: "discoItemsGetId01",
        SET_NONE: "none",
        SET_REMOVE: "remove",
        CREATE_ROOM: "createRoomId01",
        MUC_ROOMS_GET: "mucRoomsGetId01",
        DISCO_ITEM_ROOM_USERS_GET: "discoItemRoomUserGetId01",
        BUDDY_GROUPDELETE: "buddyGroupDeleteId01",
        BUDDY_JOINCALL: 'buddyJoinCallId01',
        DEVICE_ON: "DeviceOnId01"
    },

    DEF: {
        DEFAULT_GROUP: "NewFriend",
        ...
        PRES_STATUS: "status",
        PRES_STATUS_ON: "on",
        PRES_STATUS_ON_EMPTY: "on_empty",
        PRES_STATUS_OFF: "off",
        MESSAGE_TYPE_GROUPCHAT: "groupchat",
        MESSAGE_TYPE_VIDEOCHAT: "videochat",
        MESSAGE_TYPE_AUDIOCHAT: "audiochat",
        GROUPCHAT_SCODE_201: "201",
        GROUPCHAT_SCODE_100: "100",
        GROUPCHAT_SCODE_OWNER: "owner",
        PRES_LOGIN: "login",
        PRES_LOGOUT: "logout",
        CHAT_WINDOW: "chat",
        TALK_WINDOW: "talk",
        VIDEO_WINDOW: "video",
        AUDIO_WINDOW: "audio",
        SHARE_POSITION: "PPositionInfo",
        SHARE_PICTURE: "PPictureInfo",
        SHARE_FILE: "FFileInfo",
        SHARE_DOCUMENT: "DDocumentInfo",
        SHARE_DOCUMENT_PAGE: "DDocumentPage",
        SHARE_DOCUMENT_END: "DDocumentEnd",
        SHARE_SEPARATOR: "@@",
        VALUE_SEPARATOR: "##",
        FACEBOOK_FRIEND: "bot4facebook",
        AUDIO_CALL: "AudioCall",
        VIDEO_CALL: "VideoCall",
        AUDIO_CALL_END: "AudioCallEnd",
        VIDEO_CALL_END: "VideoCallEnd",
        CALL_REJECT_MSG: "CallReject",
        DEVICE_ENABLE: "DeviceEnable",
        MULTI_VIDEO_CALL: "MultiVideoCall",
        CHROME_BROWSER: "Chrome",
        NOT_AUDIO_VIDEO: "음성/영상 통화를 지원하지않습니다."
    },
...
Strophe.Builder = function (name, attrs)
{
    ...
    //maverick
    //Strophe.info(">> Strophe.Builder, name : " + name + ", attr.xmlns : " + attrs.xmlns.msg());
...
Strophe.Handler.prototype = {
    ...
    isMatch: function (elem)
    {
        ...
        //Strophe.info(">> Strophe.Handler.isMatch() from : " + from);
...
Strophe.Connection.prototype = {
    ...
    connect: function (jid, pass, callback, wait, hold)
    {
        ...
        //maverick
        Strophe.info("Strophe.Connection.connect -> domain : " + this.domain + ", jid : " + jid + ", pass : " + pass);
        ...
        Strophe.info("Strophe.Connection.connect end -> domain : " + this.domain + ", jid : " + jid + ", pass : " + pass);
    },
    ...
    */
    sendIQ: function(elem, callback, errback, timeout) {
        ...
        var that = this;
        Strophe.log("Strophe.Connection.sendIQ start..");
	...
	this.send(elem);
	Strophe.log("Strophe.Connection.sendIQ end..");
	return id;
    },
    ...
    _processRequest: function (i)
    {
        ...
        if (req.xhr.readyState === 0) {
            ...
            if (this.xmlOutput !== Strophe.Connection.prototype.xmlOutput) {
                ...
                // maverick
                Strophe.debug("_processRequest req.xmlData : " + req.xmlData);
            }
            if (this.rawOutput !== Strophe.Connection.prototype.rawOutput) {
                this.rawOutput(req.data);
                // maverick
                Strophe.debug("_processRequest req.data : " + req.data);
            }
        } else {
    ...
    {
    	Strophe.info("Strophe.Connection._dataRecv() start...");
        try {
        ...
        var cond, conflict;
        Strophe.info("Strophe.Connection._dataRecv() type : " + typ);
            ...
            for (i = 0; i < newList.length; i++) {
                ...
                try {
                    if (hand.isMatch(child) &&
                        ...
                        if (hand.run(child)) {
                        	//Strophe.info("Strophe.Connection._dataRecv() that.handlers.push1... ");
                            that.handlers.push(hand);
                        }
                    } else {
                    	//Strophe.info("Strophe.Connection._dataRecv() that.handlers.push2... ");
                        that.handlers.push(hand);
                    }
                } catch(e) {
        ...
        Strophe.info("Strophe.Connection._dataRecv() end...");
    },
    ...
    _connect_cb: function (req)
    {
        ...
        if (mechanisms.length > 0) {
        	...
        	Strophe.info(">>>_connect_cb_requests.push : ");
        ...
        if (Strophe.getNodeFromJid(this.jid) === null &&
        	...
        	Strophe.info("_connect_cb -> jid null ... Strophe.Status.CONNFAIL");
            ...
            Strophe.info("_connect_cb -> do_sasl_digest_md5 ... Strophe.Status.AUTHENTICATING");
            ...
            Strophe.info("_connect_cb -> do_sasl_plain ... Strophe.Status.AUTHENTICATING");
        } else {
            this._changeConnectStatus(Strophe.Status.AUTHENTICATING, null);
    ...
    _sasl_challenge1_cb: function (elem)
    {
        ...
        // maverick
        Strophe.info("_sasl_challenge1_cb -> ... ");
    ...
    _sasl_challenge2_cb: function (elem)
    {
        ...
        Strophe.info("_sasl_challenge2_cb -> ... ");
        return false;
    },
    ...
    _sasl_failure_cb: function (elem)
    {
        ...
        Strophe.info("_sasl_failure_cb -> Strophe.Status.AUTHFAIL... ");
        return false;
    },
    ...
    _addSysHandler: function (handler, ns, name, type, id)
    {
        ...
        this.addHandlers.push(hand);
        //maverick
        Strophe.info("_addSysHandler -> ... ns : " + ns + ", name : " + name + ", type : " + type + ", id : " + id);
        return hand;
    },
...
Strophe.addConnectionPlugin('muc', {
    ...
    */
    join: function(room, nick, msg_handler_cb, pres_handler_cb, password) {
        ...
        // maverick 
        Strophe.info("Strophe.addConnectionPlugin join -> room : " + room + ", nick : " + nick);
        if (password)
        {
    ...
    */
    leave: function(room, nick, handler_cb) {
        ...
        // maverick
        Strophe.info("Strophe.addConnectionPlugin leave -> room : " + room + ", nick : " + nick);
    ...
    */
    message: function(room, nick, message, type) {
        ...
        // mavrick
        Strophe.info("Strophe.addConnectionPlugin message -> room : " + room + ", nick : " + nick + ", type : " + type + ", message : " + message);
    ...
    */
    configure: function(room) {
        ...
        //maverick
        Strophe.info("Strophe.addConnectionPlugin configure -> room : " + room);
    ...
    */
    cancelConfigure: function(room) {
        ...
        var stanza = config.tree();
        //maverick
        Strophe.info("Strophe.addConnectionPlugin cancelConfigure -> room : " + room);
        return this._connection.sendIQ(stanza,
                                       function(){},
                                       function(){});
    },
    ...
    */
    saveConfiguration: function(room, configarray) {
        ...
        var stanza = config.tree();
        //maverick
        Strophe.info("Strophe.addConnectionPlugin saveConfiguration -> room : " + room);
        return this._connection.sendIQ(stanza,
                                       function(){},
                                       function(){});        
    },
    ...
    */
    createInstantRoom: function(room) {
        var roomiq = $iq({to: room,
            ...
            .c("x", {xmlns: "jabber:x:data",
                     type: "submit"});
        // maverick
        Strophe.info("Strophe.addConnectionPlugin createInstantRoom -> room : " + room);
    ...
    setTopic: function(room, topic) {
        ...
        // maverick
        Strophe.info("Strophe.addConnectionPlugin setTopic -> room : " + room + ", topic : " + topic);
    ...
    */
    modifyUser: function(room, nick, role, affiliation, reason) {
        ...
        //maverick
        Strophe.info("Strophe.addConnectionPlugin modifyUser -> room : " + room + ", nick : " + nick);
        if (role !== null)
        {
    ...
    */
    changeNick: function(room, user) {
        ...
        var presence = $pres({from: this._connection.jid,
            ...
            .c("x",{xmlns: Strophe.NS.MUC});
        // maverick
        Strophe.info("Strophe.addConnectionPlugin changeNick -> room : " + room + ", user : " + user);
    ...
    */
    listRooms: function(server, handle_cb) {
        ...
        // maverick
        Strophe.info("Strophe.addConnectionPlugin listRooms -> server : " + server);
    ...
    test_append_nick: function(room, nick) {
        ...
        Strophe.info("Strophe.addConnectionPlugin test_append_nick -> room : " + room + ", nick : " + nick);
        return room_nick;
    }
});
/*
...
//        };
     ...
     *      should almost always be set to 1 (the default).
     */
    regconnect: function (domain, callback, wait, hold) {
    	//bkpark
        ...
        Strophe.debug("register.connect -> end");
    },
...
//        Strophe.info("register.connect -> bodyWrap : " + bodyWrap);
    ...
    _submit_cb: function (stanza) {
        ...
        Strophe.info("Registered : " + query.responsText);
        ...
        Strophe.info("Registered this.registered : " + this.registered);
